            ...
            <div className="row">
              <div className="col-12">
                <div className="m-3">
                          ...
                          >
                            ...
                            <li>
                              <a
                                ...
                                href="javascript:;"
                              >
                                <i className="fa-regular fa-add me-2"></i> Add
                                to Report
                              </a>
                            </li>
                            <li>
                  ...
                  <div
                    id="f1"
                    className="funnel funnel-container mt-4 mb-6"
                  ></div>
            ...
            <div className="col-12">
              <div className="card p-3">
                ...
                <div className="drop-container ms-5 mb-4">
                  <div id="hcontainer" className="h-svg-container"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row m-3">
            <div className="col-5">
              <div className="card p-3 height-600">
                ...
                <div className="chartdiv" id="enroll-nbrx"></div>
              </div>
            </div>
            <div className="col-7">
